...
# 42 "/usr/include/c++/4.8.2/cstdio" 2 3
...
# 40 "/usr/include/c++/4.8.2/string" 2 3
...
# 41 "/usr/include/c++/4.8.2/bits/char_traits.h" 2 3
# 1 "/usr/include/c++/4.8.2/cwchar" 1 3
# 39 "/usr/include/c++/4.8.2/cwchar" 3
...
# 41 "/usr/include/c++/4.8.2/string" 2 3
...
#pragma GCC visibility push(default)
# 43 "/usr/include/c++/4.8.2/bits/exception_ptr.h" 3
extern "C++" {
...
# 42 "/usr/include/c++/4.8.2/bits/localefwd.h" 2 3
...
# 44 "/usr/include/c++/4.8.2/string" 2 3
...
# 40 "/usr/include/c++/4.8.2/bits/basic_string.h" 2 3
...
void PraseCommandLine(char commandbuffer[],int len)
{
 ...
 while(end>0)
 {
  if(commandbuffer[end]=='<')
  {
   ...
   commandbuffer[end]=0;
   filename=commandbuffer+end;
   ++end;
   do{ while(filename[end]==' '){ ++end; }}while(0);
   filename=commandbuffer+end;
   Redir=1;;
   break;
  }
 ...
 while((bool)(gargv[gargc++]=strtok(__null,sep)));
 --gargc;
}
...
int main()
{
 ...
 while(true)
 {
  ...
  PraseCommandLine(commandbuffer,strlen(commandbuffer));
# 450 "myshell.cc"
